  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <div className="cabecalho-com-logos flex items-center justify-between">
          ...
          <div className="titulo-central flex-1 text-center">
            <h1 className="text-3xl font-bold text-gray-800">FORMULÁRIO DE LAUDO TÉCNICO</h1>
          </div>
